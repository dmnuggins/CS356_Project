...
public class MeetingApp {
    ...
    public static void main(String args[]) {
        ...
        EmployeeMeetingDB.getInstance().save(new EmployeeMeeting(0, 0, 0, true, true, true));
        EmployeeMeetingDB.getInstance().save(new EmployeeMeeting(1, 1, 0, false, false, false));
        EmployeeMeetingDB.getInstance().save(new EmployeeMeeting(2, 2, 0, false, false, false));
        EmployeeMeetingDB.getInstance().save(new EmployeeMeeting(3, 3, 0, false, false, false));
        EmployeeMeetingDB.getInstance().save(new EmployeeMeeting(4, 4, 0, false, false, false));
        EmployeeMeetingDB.getInstance().save(new EmployeeMeeting(5, 5, 0, false, true, true));
        EmployeeMeetingDB.getInstance().save(new EmployeeMeeting(6, 6, 0, false, true, true));
